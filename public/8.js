                      ...
                      _c(
                        ...
                        [
                              ...
                              directives: [
                                {
                                  ...
                                  rawName: "v-show",
                                  value:
                                    item.tiene_descuento_porprod == 0 &&
                                    item.tiene_descuento_pormrc == 0,
                                  expression:
                          ...
                          _c(
                              ...
                              directives: [
                                {
                                  ...
                                  rawName: "v-show",
                                  value:
                                    item.tiene_descuento_porprod == 1 &&
                                    item.tiene_descuento_pormrc == 0,
                                  expression:
                            ...
                            [_vm._v(_vm._s(item.precio_descuento_porprod))]
                          ),
                          _vm._v(" "),
                          _c(
                            "td",
                            ...
                            [
                              _vm._v(
                                _vm._s(item.precio_total_descuento_porprod)
                              )
                            ]
                          ),
                          _vm._v(" "),
                              ...
                              directives: [
                                {
                                  ...
                                  value:
                                    item.tiene_descuento_porprod == 0 &&
                                    item.tiene_descuento_pormrc == 1,
                                  expression:
                                    "item.tiene_descuento_porprod==0 && item.tiene_descuento_pormrc==1"
                                }
                              ]
                            },
                            [_vm._v(_vm._s(item.precio_descuento_pormrc))]
                          ),
                          _vm._v(" "),
                          _c(
                            "td",
                            ...
                            [_vm._v(_vm._s(item.precio_total_descuento_pormrc))]
                          ),
                          _vm._v(" "),
                          _c(
                            "td",
                                ...
                                directives: [
                                  {
                                    name: "show",
                                    rawName: "v-show",
                                    value: _vm.bolTraerPDFReport,
                                    expression: "bolTraerPDFReport"
                                  }
                                ],
                                attrs: { type: "border", small: "" }
                              }),
